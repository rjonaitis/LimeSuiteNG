...
static void la9310_dump_dma(std::shared_ptr<LA9310_PCIe> pcie)
{
    ...
    for (int i = 0; i < DMA_TABLE_LINE_COUNT; ++i)
    {
        ...
        printf("|addr:%08X sz:%8u phyt:%08X_%08X f:%04X\n", row[i].addr, row[i].size, row[i].timestamp >> 32, row[i].timestamp, row[i].flags);
    }
}
...
int main(int argc, char* argv[])
{
    ...
    if (trace)
    {
        ...
        fout << "{\"name\": \"process_name\", \"ph\": \"M\", \"pid\": 1000, \"args\": {"
            "\"name\" : \"DMA_WR_priority\" }"
            "}\n";
        fout << "{\"name\": \"process_name\", \"ph\": \"M\", \"pid\": 1001, \"args\": {"
            "\"name\" : \"ADC_RO0\" }"
            "}\n";
        fout << "{\"name\": \"process_name\", \"ph\": \"M\", \"pid\": 1002, \"args\": {"
            "\"name\" : \"VSPA_DMA\" }"
            "}\n";
        fout << "{\"name\": \"process_name\", \"ph\": \"M\", \"pid\": 1003, \"args\": {"
            "\"name\" : \"ADC_RX0\" }"
            "}\n";
        fout << "{\"name\": \"process_name\", \"ph\": \"M\", \"pid\": 1004, \"args\": {"
            "\"name\" : \"ADC_RX1\" }"
            "}\n";
        fout << "{\"name\": \"process_name\", \"ph\": \"M\", \"pid\": 1005, \"args\": {"
            "\"name\" : \"AUX_ADC\" }"
            "}\n";
        fout << "{\"name\": \"process_name\", \"ph\": \"M\", \"pid\": 1006, \"args\": {"
            "\"name\" : \"RSSI_RD\" }"
            "}\n";
        fout << "{\"name\": \"process_name\", \"ph\": \"M\", \"pid\": 1007, \"args\": {"
            "\"name\" : \"DDR_RD1\" }"
            "}\n";
        fout << "{\"name\": \"process_name\", \"ph\": \"M\", \"pid\": 1008, \"args\": {"
            "\"name\" : \"DDR_RD2\" }"
            "}\n";
        fout << "{\"name\": \"process_name\", \"ph\": \"M\", \"pid\": 1009, \"args\": {"
            "\"name\" : \"DDR_RD3\" }"
            "}\n";
        fout << "{\"name\": \"process_name\", \"ph\": \"M\", \"pid\": 1010, \"args\": {"
            "\"name\" : \"DDR_RD4\" }"
            "}\n";
        fout << "{\"name\": \"process_name\", \"ph\": \"M\", \"pid\": 1011, \"args\": {"
            "\"name\" : \"DAC\" }"
            "}\n";
        fout << "{\"name\": \"process_name\", \"ph\": \"M\", \"pid\": 1012, \"args\": {"
            "\"name\" : \"DDR_WR1\" }"
            "}\n";
        fout << "{\"name\": \"process_name\", \"ph\": \"M\", \"pid\": 1013, \"args\": {"
            "\"name\" : \"DDR_WR2 TRACE\" }"
            "}\n";
        fout << "{\"name\": \"process_name\", \"ph\": \"M\", \"pid\": 1014, \"args\": {"
            "\"name\" : \"DDR_WR3\" }"
            "}\n";
        fout << "{\"name\": \"process_name\", \"ph\": \"M\", \"pid\": 1015, \"args\": {"
            "\"name\" : \"DDR_WR4 State\" }"
            "}\n";
